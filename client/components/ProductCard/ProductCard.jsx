...
export default function ProductCard({ product, setItems, items }) {
  ...
  return (
    <div style={{ padding: "1px" }}>
      <Card className={styles.wrapper} borderRadius='15px'>
        <CardBody>
          ...
          >
            <Stack spacing="3" flexDirection="column">
              ...
              <Box display="flex" alignItems="center">
                ...
                <Text ml="5%">{product.rating}</Text>
              </Box>
            </Stack>
            <Stack spacing="3" flexDirection="column" alignItems="center">
              <Heading size="sm" marginTop="1px" color="orange.400">
                {product.price} ₽
              </Heading>
              {items.find((el) => el.id === product.id) ? (
                <svg
                  width="19"
                  height="20"
                  viewBox="0 0 24 25"
